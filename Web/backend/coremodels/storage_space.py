...
class StorageSpace(models.Model):
    id = models.CharField(max_length=15, primary_key=True) ## this is the qr_code
    storage_unit = models.ForeignKey(StorageUnit, on_delete=models.CASCADE)
    article = models.ForeignKey(Article, on_delete=models.CASCADE, null=True, blank=True, db_constraint=False)
