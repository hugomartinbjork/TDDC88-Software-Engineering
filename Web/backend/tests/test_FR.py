...
class FR4_3_Test(TestCase):
    ...
    def test_FR4_3(self):
        ...
        #test that the third article is not in the same storage spaces as article 1
        article2 = self.article_management_service.getArticleByLioId("2")
        self.assertNotEqual(storagespace1.article, article2)
        self.assertNotEqual(storagespace2.article, article2)
#Testing FR6.2
