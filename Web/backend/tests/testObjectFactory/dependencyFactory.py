...
class DependencyFactory():
    def __init__(self) -> None:
        servicepath = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..','..', 'services'))
        ...
        data_access_path = os.path.abspath(os.path.join(os.path.dirname( __file__ ), '..','..', 'dataAccess'))
...
#Used to mimic a dependency that is not being used
