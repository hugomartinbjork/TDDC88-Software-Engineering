# Generated by Django 4.1.1 on 2022-11-08 09:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('amount', models.PositiveSmallIntegerField(default=0)),
                ('time_of_transaction', models.DateField(blank=True, default=datetime.datetime(2022, 11, 8, 9, 40, 42, 750689, tzinfo=datetime.timezone.utc), null=True)),
