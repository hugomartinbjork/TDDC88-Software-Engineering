    ...
    def register(self, name=None):
        ...
        def decorator(thing):
            ...
            if not name:
                ...
                thing_name = name   #Set the name of the dependency to a name specified in the register function
            self.deps[thing_name] = thing # I don't think we will be doing this //Elias
            return thing
